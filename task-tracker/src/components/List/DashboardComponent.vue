            ...
            <div id="weekly-section" class="task-wrapper">
                <span class="list-section-title">
                    ...
                    <p class="list-section-hours">
                        Total hours worked: <span class="total-today">{{ computeTotalHours(aWeeklyTasks) }}h</span>
                    </p>
                </span>
                <div class="list-task" v-if="aWeeklyTasks === undefined">
                    <span class="empty-placeholder">No data to show</span>
                </div>
                <span v-if="aWeeklyTasks.length > 0">
                    <div class="list-task" v-for="task in aWeeklyTasks" :key="task.task_id">
                        ...
                        <div class="edit-col" @click="editTask(task.task_id)">
                            <img width="25" height="25" src="https://img.icons8.com/sf-regular/25/14a4ad/create-new.png" alt="create-new"/>
                        </div>
                        
                        <div class="del-col" @click="removeTask(task.task_id)">
...
export default {
    ...
    computed: {
        ...mapState('store', ['oUserData', 'aWeeklyTasks'])
    },
    methods: {
        ...
        editTask(iTaskId) {
            var oTaskInfo = _.find(this.aWeeklyTasks, { 'task_id': iTaskId });
